...
const decoracoesRef = ref(decoracoes);
...
<template>
  ...
  <div class="text-h1">
    <h1 class="animate__animated animate__fadeInDown">Decoracoes Em Alta!</h1>
  </div>
  <div class="before">
    <div class="container">
      <div class="item animate__animated animate__fadeInLeft" v-for="(item, index) in decoracoesRef" :key="index">
...
main {
 background-image: url('https://4.bp.blogspot.com/-89eE3pBIxP8/T48DG3G1h3I/AAAAAAAAACk/SErOBhLAyGc/s1600/IMG_0160.jpg');
