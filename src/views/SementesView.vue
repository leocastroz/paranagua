...
const sementesRef = ref(sementes);
...
<template>
  ...
  <div class="text-h1">
    <h1 class="animate__animated animate__fadeInDown">Nossas sementes</h1>
  </div>
  <div class="before">
    <div class="container"> 
      <div class="item animate__animated animate__fadeInLeft" v-for="(item, index) in sementesRef" :key="index">
...
main {
 background-image: url('https://allianceofhope.org/wp-content/uploads/2021/01/AdobeStock_246697517-Cropped-to-GR-scaled.jpg');
