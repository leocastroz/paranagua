...
<template>
  ...
  <div class="text-h1">
    <h1 class="animate__animated animate__fadeInDown">Vasos Mais Vendidos</h1>
  </div>
  <div class="before">
    <div class="container">
      <div class="item animate__animated animate__fadeInLeft" v-for="(item, index) in vasosRef" :key="index">
...
main {
 background-image: url('https://images.pexels.com/photos/793012/pexels-photo-793012.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260');
