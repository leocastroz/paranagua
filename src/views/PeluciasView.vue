...
<template>
  ...
  <div class="text-h1">
    <h1 class="animate__animated animate__fadeInDown">Nossas pelucias e Plantas</h1>
  </div>
  <div class="before">
    <div class="container">
...
<style scoped>
main {
  background-image: url('https://i0.wp.com/jornalaw.com.br/wp-content/uploads/2023/04/bichinhos-de-pelucia-como-lavar.webp?fit=924%2C616&ssl=1');
